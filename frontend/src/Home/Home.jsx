...
export default function Home() {
    ...
    function handleSubmit(e) {
        ...
        axios.post("https://hospitalapplication-4hl3.onrender.com/api/appointments/add", newAppointment)
            .then((res) => {
                console.log(res)
                if(res.status===201){
    ...
    async function fetchDoctors() {
        await axios.get("https://hospitalapplication-4hl3.onrender.com/api/doctors")
            .then((res) => {
